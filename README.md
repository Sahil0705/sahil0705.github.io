...
<nav class="navbar navbar-inverse" style="top:0; right:0; left:0; position:fixed; z-index: 23;">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#co">Sahil</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#mp">Projects</a></li>
        <li><a href="#cd">Contact</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<p align='center' style="font-family:Trebuchet MS ; font-size:30px; color:white;"><i><b>Oracle Certified</b></i></span><br>
  <hr width=50%>
<p align='center' style="font-family:Trebuchet MS; font-size:20px; color:white;"><i><b>2nd Year Computer Science student at VIT Chennai</b></i></span><br><br><br><br>
    ...
    <p align='center' style="font-size: 20px; font-family:Arial Verdana; line-height:30px;">I am currently pursuing my Btech in Computer Science & Engineering from VIT University Chennai Campus. I like coding websites and building games. There is a lot to learn in web development from my side and looking forward to make some projects on the same. Besides, for refreshments I play many outdoor games and listen to good music.</p><br>
    <div class="container" style="z-index: 24;">
        <div class="row">
          <div class="col-md-4">
            <div class="thumbnail">
      ...
      <table align='center'>
        <tr colspan=2>
          <td align='center'><h2 style="font-size:40px; font-family:Times-Italic;""><b>Educational Qualifications<br></b></h2></td>
        </tr>
        <tr>
          <td align='center'><h4 style="font-size: 19px; font-family:Trebuchet MS; line-height:35px;">Currently persuing B-tech in Computer Science and Engineering from VIT Chennai</b></h4></td>
        </tr>
        <tr>
...
<br id='S'><br>
      <table align='center' width=100% id='t4'>
        ...
        <tr><td><p align='center' style="font-family:Trebuchet MS; font-size:22px;">I am in the process of learning the following technical skills, out of which some of them I have used in my projects</p><br><br></td></tr>
      </table>
      ...
      <br id='mp'><br>
      <!-- <h2 align='center' style="font-size:40px; font-family:Times-Italic;"><b><i><br>My Projects</i></b></h2>
      <br>
  
          <div class="w3-display-container mySlides">
        <p align='center'><img src="onlineshopping.jpg" style="width:1150px; height:600px; border-radius: 30px;"></p>
        <div class="w3-display-topright w3-large w3-container w3-padding-16 w3-black"><h1 align='center'>Online e-commerce shopping website</h1>
          ...
          6. The user can view all his orders which he/she has bought till date.</p>
        </div>
      </div>
      
      <div class="w3-display-container mySlides">
        <p align='center'><img src="tictactoe.jpg" style="width:1150px; height:600px; border-radius: 30px;"></p>
        <div class="w3-display-topleft w3-large w3-container w3-padding-16 w3-black"><h1 align='center'>Tic-Tac-Toe</h1>
          <p align='center' style="font-size: 22px; font-family:Trebuchet MS;  line-height:35px;">I made a user friendly Tic-Tac-Toe game using C++, majorly using arrays concept.<br><b>Concepts used in this code are:</b><br>-1D Arrays - 2D Arrays - Generating random number - - Conditional Statements i.e. IF and ELSE
            ...
            3.4- If no one wins then the game stops with the message saying that match drawn</p>
        </div>
      </div>
      ...
      <div class="w3-display-container mySlides">
        <p align='center'><img src="snake.jpg" style="width:1150px; height:600px; border-radius: 30px;"></p>
        <div class="w3-display-middle w3-large w3-container w3-padding-16 w3-black"><h1 align='center'>Snakes & Ladders</h1>
          <p align='center' style="font-size: 22px; font-family:Trebuchet MS;  line-height:35px;">I wrote a python program to play text-based snake and ladder game in the terminal.<br><b>Concepts used in this code are:</b><br>
            ...
            3.5- else remain there and let the second player roll the dice</p>
        </div>
      </div>
       ...
       <p align='center'><img src="assets/images/tictactoe.jpg" style="width:95%; height:350px"></p>
        <div class="w3-display-topright w3-large w3-container w3-padding-16 w3-black">
            ...
            <p align='center' style="font-size: 22px; font-family:Trebuchet MS;  line-height:35px;">I made a user friendly Tic-Tac-Toe game using C++, majorly using arrays concept.<br><b>Concepts used in this code are:</b><br>-1D Arrays - 2D Arrays - Generating random number - - Conditional Statements i.e. IF and ELSE
              ...
              3.2- Users have the option of choosing x/0
              3.3- As soon as all 3 rows/columns of a user is filled by the same character that user wins.
              3.4- If no one wins then the game stops with the message saying that match drawn<br>Click the given link and download the game and make sure you open it in a desktop <a href='https://drive.google.com/file/d/11-gMvSbDmat6ehWu0JKjmOd6ktG0MDq-/view?usp=sharing'>Tic-Tac-Toe</a></p>
        </div>
      </div>
      ...
      <div class="w3-display-container mySlides">
        ...
        <div class="w3-display-middle w3-large w3-container w3-padding-16 w3-black">
            ...
            <p align='center' style="font-size: 22px; font-family:Trebuchet MS;  line-height:35px;">I wrote a python program to play text-based snake and ladder game in the terminal.<br><b>Concepts used in this code are:</b><br>
              ...
              3.3- If the player is on snake's head, move down to its tail
              3.4- If the player is on ladder's bottom, take it to its top
              3.5- else remain there and let the second player roll the dice<br>Click the given link and download the game and make sure you open it in a desktop <a href='https://drive.google.com/file/d/1K5Q3i65iEx3TxT6tFuTz1YbICw33U3tF/view?usp=sharing'>Snakes & Ladders</a></p>
        </div>
      </div>
      <table align='center'>
        <tr><td><button class="w3-button w3-display-left w3-black" onclick="plusDivs(-1)">&#10094;</button>&nbsp;&nbsp;</td>
...
<img src="https://hitwebcounter.com/counter/counter.php?page=7533248&style=0032&nbdigits=6&type=page&initCount=0" title="Web Counter" Alt="counter free"   border="0" >
</a>         
<br><br>
<p align='center'>Unique Views :-</p>
<!-- hitwebcounter Code START -->
<a href="https://www.hitwebcounter.com" target="_blank">
<img src="https://hitwebcounter.com/counter/counter.php?page=7533250&style=0032&nbdigits=6&type=ip&initCount=0" title="Web Counter" Alt="counter free"   border="0" >
</a>   
<br id='cd'>
<br><br>
<table align='center' width=100% style="background-color: white;">
...
<table width=100% height=60px style="bottom:0; left:0; right:0; background-color: black;">
	<tr><td align='center'><font color=white size=4px>Copyright 2020 @Sahil Sachin Donde</font></td></tr></table>
...
<!-- <ul class="topnav">
    <li class="left"  style="	color:white;
    font-size: 20px;
    font-family: Arial Rounded MT Bold;
    width:8%;
    text-align: center;"><span id='s'><a href="#co">SAHIL</a></span></li>
    <li class="right" style="	color:white;
    font-size: 20px;
    font-family: Arial Rounded MT Bold;
    width:9%;
    text-align: center;"><a href="#cd">Contacts</a></li>
    <li class="right" style="	color:white;
    font-size: 20px;
    font-family: Arial Rounded MT Bold;
    width:9%;
    text-align: center;"><a href="#mp">Projects</a></li>
    <li class="right" style="	color:white;
    font-size: 20px;
    font-family: Arial Rounded MT Bold;
    width:9%;
    text-align: center;"><a href="#S">Skills</a></li>
    <li class="right" style="	color:white;
    font-size: 20px;
    font-family: Arial Rounded MT Bold;
    width:9%;
    text-align: center;"><a href="#am">About Me</a></li>
    <li class="right" style="	color:white;
    font-size: 20px;
    font-family: Arial Rounded MT Bold;
    width:9%;
    text-align: center;"><a href="#h">Home</a></li>
</ul>
